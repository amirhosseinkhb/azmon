...
namespace AzmonNew.Persistence.Migrations
{
    ...
    [Migration("20220427104510_deleteingPackInQuestion")]
    partial class deleteingPackInQuestion
    {
            ...
            modelBuilder.Entity("AzmonNew.Domain.Entities.Questions.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2022, 4, 27, 15, 15, 9, 951, DateTimeKind.Local).AddTicks(2895),
                            IsRemoved = false,
                            Name = "C#"
                        });
                });
